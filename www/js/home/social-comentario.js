...
function enviarComentario() {
    ...
    var comentario = jQuery('#comentarioComPost').val();
    var date = new Date();
    var objComentario = {
        "usu_id": usuario.id,
    ...
    $.ajax({
        ...
        headers: {},
        success: function(retorno) {
            $('#comentarioComPost').val("");
            $('#modalComentarioPost').closeModal();
            buscarComentarios();
        },
        error: function() { },
        contentType: 'application/x-www-form-urlencoded'
...
function openModalComentarioPost() {
    $('#modalComentarioPost').openModal();
    $('#comentarioComPost').val("");
    $('#comentarioComPost').focus();
}
